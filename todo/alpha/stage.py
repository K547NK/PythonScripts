...
settingsDirectory = os.path.expanduser('~/Documents/ToDo/settings/')  #working directory handling

home = os.path.expanduser('~/Documents/ToDo/')  #settings directoru handling
...
print ('Today is day '+ str(julian)+' of '+str(year)) #Today's Julian date
