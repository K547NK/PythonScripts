...
x = 0
for x in deck:
    print(string(random.shuffle(x))) # show different values instead of following a linear index
while x == 52:                       # xxx
  break
#Players
...
#Shuffle Darks
shuffleCards = random.shuffle(deck)
#Deal the cards
dealCards = shuffleCards # separate the deck into 4 groups each containing 13 cards
